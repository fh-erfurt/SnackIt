<link rel='stylesheet' type='text/css' href='assets/css/agb.css'>
...
<div class="agb">
    <h1>Allgemeine Geschäftsbedingungen der Firma SnackIt</h1> <br />
    ...
    (1) Die folgenden Regelungen über den Vertragsabschluss gelten für Bestellungen über unseren Internetshop https://www.SnackIt.de .<br />
    <br />
    <b>(2) Im Falle des Vertragsschlusses kommt der Vertrag mit<br />
        ...
        <div style="font-weight: bold; margin-left: 20px;">
            <br />
            SnackIt<br />
            Lukas Arnold, Marvin Hof, Thomas Konietzny<br />
            Altonaer Str. 25<br />
            D-99085 Erfurt<br />
            Registernummer <br />
            Registergericht <br />
    ...
    E-Mail zu. Die AGB können Sie jederzeit auch unter https://www.SnackIt.de/AGB.php einsehen.
    ...
    <div style="margin-left:20px; margin-top: 5px; margin-bottom:5px;">
        ...
        Altonaer Str. 25<br />
        D-99085 Erfurt<br />
        E-Mail SnackIt.firma@gmail.com<br />
    </div>
